    ...
    return (
        <div className="w-full h-32 bg-slate-100 dark:bg-slate-800 rounded-xl overflow-hidden relative border border-gray-200 dark:border-slate-700 mb-4 shadow-inner">
            ...
            <div
                ...
                ${play && type === 'search' ? 'animate-[cursor-search_4.096s_ease-in-out_1_both]' : ''}
                ${play && type === 'favorites' ? 'animate-[cursor-fav_4.096s_ease-in-out_1_both]' : ''}
                ${play && type === 'templates' ? 'animate-[cursor-temp_4.096s_ease-in-out_1_both]' : ''}
                ${play && type === 'clients' ? 'animate-[cursor-client_4.096s_ease-in-out_1_both]' : ''}
                ${play && type === 'settings' ? 'animate-[cursor-settings_4.096s_ease-in-out_1_both]' : ''}
            `}>
                ...
                {type === 'search' && (
                    <div className="w-3/4 h-8 bg-white dark:bg-slate-700 rounded-lg border border-gray-200 dark:border-slate-600 flex items-center px-3 relative">
                        ...
                        <div className={`h-2 bg-slate-200 dark:bg-slate-500 rounded w-0 ${
                            play ? 'animate-[width-grow_4.096s_ease-in-out_1_both]' : ''
                        }`}></div>
                    </div>
                )}
                {type === 'favorites' && (
                    <div className="flex items-center gap-3 bg-white dark:bg-slate-700 p-2 rounded-lg border border-gray-200 dark:border-slate-600 w-3/4">
                        ...
                        <Star className={`w-5 h-5 text-slate-300 ${
                            play ? 'animate-[star-pulse_4.096s_ease-in-out_1_both]' : ''
                        }`} />
                    </div>
                )}
                {type === 'templates' && (
                    <div className="flex gap-2">
                        <div className="w-16 h-20 bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg p-2 space-y-2">
                         ...
                         <div className={`w-16 h-20 bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-lg p-2 space-y-2 opacity-0 ${
                             play ? 'animate-[fade-in-delayed_4.096s_ease-in-out_1_both]' : ''
                         }`}>
                ...
                {type === 'clients' && (
                    <div className="relative w-full max-w-[180px]">
                        ...
                        <div className={`absolute -bottom-4 -right-2 bg-brand-500 text-white p-1 rounded-full ${
                            play ? 'animate-[pop-in_4.096s_ease-in-out_1_both]' : ''
                        }`}>
                        ...
                        <div className="flex justify-between items-center bg-white dark:bg-slate-700 p-2 rounded border border-gray-200 dark:border-slate-600">
                             ...
                             <div className="w-8 h-4 bg-slate-200 dark:bg-slate-600 rounded-full relative overflow-hidden">
                                 <div className={`absolute left-0 top-0 bottom-0 w-4 bg-slate-400 rounded-full ${
                                     play ? 'animate-[toggle_4.096s_ease-in-out_1_both]' : ''
                                 }`}></div>
                             </div>
                        </div>
                    </div>
